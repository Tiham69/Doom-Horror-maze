...
class NPC(AnimatedSprite):
    def __init__(self, game, path='resources/cyber_demon/0.png', pos=(10.6, 5.5),
                 scale=0.6, shift=0.38, animation_time=280):
    ...
    # class SolderNPC(NPC):
    #     def __init__(self, game, path='', pos=(10, 5),
    ...
    # class CyberDeamonNPC(NPC):
    #     def __init__(self, game, path='', pos=(9.5, 4.5),
